...
import myoptaplannerexamples.knapsack.KnapsackSolution;
...
public class KnapsackController {
  ...
  public String calculateAction() throws Exception {
    KnapsackSolution knapsack = new KnapsackSolution();
    ...
    if (solverFile.exists()) {
      ...
      solverFactory = SolverFactory.createFromXmlInputStream(context.getResourceAsStream("/WEB-INF/classes/solvers/knapsack.xml"));
    }

    Solver solver = solverFactory.buildSolver();
    Task<KnapsackSolution> task = new Task<KnapsackSolution>(solver, knapsack);
