...
import myoptaplannerexamples.graphcoloring.GraphSolution;
...
public class GraphColoringController {
  ...
  public String setVertexNumberAction(@ModelAttribute("vertexNumber") int vertexNumber, BindingResult bindingResult, Model model) {
  ...
  public String addEdgeAction(@ModelAttribute("vertexA") int vertexA, @ModelAttribute("vertexB") int vertexB, BindingResult bindingResult,
                              Model model) {
  ...
  public String solveAction() {
    GraphSolution graph = new GraphSolution();
    ...
    if (solverFile.exists()) {
      ...
      solverFactory = SolverFactory.createFromXmlInputStream(context.getResourceAsStream("/WEB-INF/classes/solvers/graphcoloring.xml"));
    }

    Solver solver = solverFactory.buildSolver();
    Task<GraphSolution> task = new Task<GraphSolution>(solver, graph);
