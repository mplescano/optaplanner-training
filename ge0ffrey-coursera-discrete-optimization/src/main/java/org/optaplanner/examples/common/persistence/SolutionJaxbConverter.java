 ...
 */
public class SolutionJaxbConverter<Solution_> extends LoggingMain {

    public static <Solution_> SolutionJaxbConverter<Solution_> createImportConverter(String dataDirName,
        ...
        JaxbSolutionFileIO<Solution_> outputSolutionFileIO = new JaxbSolutionFileIO<>(solutionClass);
        return new SolutionJaxbConverter<>(dataDirName,
                inputSolutionFileIO, "import", importer.isInputFileDirectory(),
                outputSolutionFileIO, "unsolved");
    }

    public static <Solution_> SolutionJaxbConverter<Solution_> createExportConverter(String dataDirName,
            Class<Solution_> solutionClass, AbstractSolutionExporter<Solution_> exporter) {
    	CustomJaxbSolutionFileIO<Solution_> inputSolutionFileIO = new CustomJaxbSolutionFileIO<>(solutionClass);
    ...
    private SolutionJaxbConverter(String dataDirName,
